...
static const char example[] =
  "GIooBBGICCDDGAAooLHoJEELHoJKoLooJKFF"
  "oooooIBBCCCIoAAoHJooooHJoxGEEoooGFFF"
  "BBBoxoGooxLMGAAKLMGIoKEEHIJooNHIJFFN"
  "oBBBCCDDDooKAAoooKEEEFFKJGGGHHJooIII"
  "BBBoooooxDDDAAIoooEEIoJooHFFJooHGGoo"
  "JBBBCCJoxooMJoKAAMooKEEMoFFLooxHHLII"
  "BBCCCIoooGHIAAoGHJEFDDDJEFooooEooooo"
  "oBBooooCCIoxAAHIooGoHEEKGoHJoKFFFJoK"
  "oFoooxxFDDoJAAGIoJooGIEEooHIooooHooo"
  "BBooKLFHooKLFHAAKLGICCooGIJDDDooJEEE"
  "oxCCKLoooIKLAAoIKLoHoJDDGHoJooGEEFFo"
  "BBoIxxoooIooAAoIooooooJKGHEEJKGHFFFo"
  "BBooIooFCCIJoFAAIJoGHoDDoGHooKEEEooK"
  "BBoooooooxooGAAJKLGIoJKLHIDDKLHEEFFo"
  "oooIBBoCCIoKoGHAAKoGHoJLoGxxJLFFFoJo"
  "ooEGooooEGoIAAFGHIooFoHJoDBBHJoDCCCo"
  "ooxCCLooooKLGoAAKMGDDJKMHIoJooHIEEFF"
  "oxCCCooDDDooAAKLooJoKLEEJFFGGMooxIIM"
  "GBBCCKGoHooKAAHoJKoDDIJoEEEIJoFFoooo"
  "oGBBJKoGHIJKAAHIoLooooxLDDDooLoEEFFF"
  "ooJBBoHIJoMoHIAAMoooKCCoDDKLoxFFFLox"
  "BBCCCKDDooJKGHAAJLGHIooLoHIEEEFFFooo"
  "HBBooxHoJDDoAAJLooIoKLEEIoKFFMIGGGoM"
  "BBBoJooHooJKoHoAAKooxDDKEEoIoooxoIGG"
  "oIoBBooICCKLoIAAKLHDDJKoHooJEEHFFGGo"
  "BBBJKMoooJKMoAAJLoCCIoLoHoIDDxHFFFGG"
  "oxoCCooooJDDAAoJKLHEEEKLHoIoKLxoIGGG"
  "GBBJKLGCCJKLAAIooLDDIooooHEEFFoHoooo"
  "oBBCCoooIDDxAAIJoKHFFJoKHooJGGHooooo"
  "oxCCCMxEELoMJAALoNJFFGGNooKHHHooKoII"
  "GBBCCKGoDDoKGAAIJLEEHIJLooHFFFoooooo"
  "GBBBooGoHICCAAHIoKoooJoKoooJDDooxFFF"
  "HBBBKLHCCxKLAAIoooEEIJoxGGGJoooooooo"
  "BBoooKCCDDDKFoAAJLFoHIJLGoHIJoGoHIEE"
  "oxCCoooIoDDMoIAALMEEFFLMooJKGGHHJKoo"
  "JBBCCCJoKDDMAAKooMEEELoooxoLGGxooIII"
  "BBBCCJooGooJAAGoIKFDDHIKFEEHIKoooooo"
  "FoHoooFGHBBLFGAAJLooooJMCCoIKMDDDIKx"
  "xoJCCLooJDDLoAAKoooIoKEEoIFFFxHHoooo"
  "BBBHJKFooHJKFAAIooCCGIDDooGEELoooooL"
  "xICCLoHIDDLoHAAKLoooJKEEooJFFMoGGGoM"
  "oxoCCoJoDDMoJAAoMNEEFFMNGGKLoooxKLII"
  "BBCCoLIDDDoLIAAKooEEJKooooJFFFGGGHHo"
  "ooxCCLDDDJoLAAIJooooIEEoHoFFKoHGGGKo"
  "HBBJKLHoIJKLAAIJoooCCCxxFFFoooGGoooo"
  "oHBBCCoHIoooAAIJoKGDDJoKGEEooKGFFFoo"
  "xoHCCCFoHIoKFAAIoKoooIJLoGDDJLoGEEEo"
  "xoCCoKGooIoKGAAIoLDDHJoLooHJEEoooxoo"
  "BBGCCoFoGoIoFAAoIoFDDDIooooHEEoooHoo"
  "ooxHCCoooHoooAAIJKDDDIJKooGEEKooGFFo"
  "BBBooMIxDDoMIAALoMIooLEEJxKGGoJoKHHH"
  "GoBBCCGoHDDDAAHoJKoooIJKEEEIJLoooFFL"
  "ooxCCCDDKoooAAKLooJEELFFJGGooMHHIIIM"
  "BBBJooHooJooHAAKoLCCIKxLooIEELooxoGG"
  "oGBBCCoGoIooAAoIJKoDDDJKooHEEKFFHooo"
  "GBBoKoGoHoKxooHAALDDDJoLooIJEEFFIJoo"
  "BBBoxMIDDDoMIoKAAMEEKLooJooLFFJGGGxo"
  "oooHooooGHBBAAGIJoCCoIJoFDDDKoFoEEKo"
  "BBBCCMooKDDMAAKoLoEEFFLoJooGGxJooIIo"
  "xCCCLMooKoLMAAKooNoJDDxNIJFFoNIGGHHH";
